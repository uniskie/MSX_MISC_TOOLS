...
OSの差を吸収するため、現在はVL ゴシックとHakGenまたはUDEV Gothicの使用を前提に調整しています。
...
MSXCR_ROMDUMPER for FW260531 のpythonポート
Windows以外の方向け

使い方は本家参照のこと   
https://github.com/v9938/MSXPLAYer_GameAdapter

## 最後に

Python+tkInterの練習確認用に適当に作ったものなので、改変はご自由に。
あまり弄りたいものではないですね。
